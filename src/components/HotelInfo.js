...
const HotelInfo = () => {
  ...
  const LoadServiceData = async() => {
    const resp = await fetch('https://jjcsx4hqzd.execute-api.us-east-1.amazonaws.com/Production/services');
  ...
  const LoadAccessibilityData = async() => {
    const resp = await fetch('https://jjcsx4hqzd.execute-api.us-east-1.amazonaws.com/Production/accessibilities');
    let jsonData = await resp.json();
